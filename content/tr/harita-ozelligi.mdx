...
```mermaid
flowchart LR
  device(["GPS kullanan cihaz"]) -->|Konum ve telemetri| database[("PxServ proje veritabanı")]
  database --> map["Harita paneli"]

  classDef external fill:#121419,stroke:#596273,color:#e5e7eb,stroke-width:1.25px
  classDef storage fill:#161528,stroke:#7167a8,color:#ede9fe,stroke-width:1.5px
  classDef interface fill:#0d1d27,stroke:#2f86a8,color:#e0f2fe,stroke-width:1.25px
