...
After setup, follow the [25 PxServ projects](/en/projects/) from maker fundamentals to production-minded IoT patterns. Every project includes a parts list, wiring table, complete firmware example, test procedure, and troubleshooting guidance.
