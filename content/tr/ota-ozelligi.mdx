...
```mermaid
flowchart LR
  build[/".bin dosyasını derle"/] --> upload[["Panele yükle<br/>ve aktifleştir"]]
  upload --> check["Cihaz güncellemeyi<br/>kontrol eder"]
  check --> install["İndir ve flash<br/>belleğe yaz"]
  install --> restart(["Yeni sürümle<br/>yeniden başlat"])
